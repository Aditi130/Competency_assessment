...
/**
 * Servlet implementation class B_E_Question
 */
@WebServlet("/B_E_Question")
public class B_E_Question extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request
					.getRequestDispatcher("/Student_medicalExam_Show_Drives.jsp");
