...
/**
 * Servlet implementation class Mechanical
 */
@WebServlet("/Mechanical")
public class Mechanical extends HttpServlet {
...
//		String username = (String) session.getAttribute("Semail");
		...
		try {
			...
			RequestDispatcher rd = request
					.getRequestDispatcher("/SubStudent_Show_Result.jsp");
