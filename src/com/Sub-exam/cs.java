...
public class cs extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String username = emailid;//(String) session.getAttribute("Semail");

		try {
			Connection con = Dbconn.conn();
			Statement st = con.createStatement();
			st.executeUpdate("delete from tblsubresult where username='" + emailid
					+ "'");
			...
			RequestDispatcher rd = request
					.getRequestDispatcher("/Sub_Student_Ele_Exam_Show_Drives.jsp");
