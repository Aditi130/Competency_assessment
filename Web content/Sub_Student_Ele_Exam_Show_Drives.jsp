	...
	<section class="container">
		<div class="row">
			<div>
				...
				<form class="form-light mt-20" role="form" action="Ele"
					method="post">
					<table  style="width: 100%">
						...
						<%
							...
							ResultSet rs1 = st1
									.executeQuery("select * from sub_co_question_and_answer where Exam_Type='Electrical_Question'");
							while(rs1.next())
							{
							...
							ResultSet rs = st
									.executeQuery("select * from sub_co_question_and_answer where Exam_Type='Electrical_Question' and id='"+sid+"'");
							if(rs.next()) {
								if (m == 1) {
							...
							String Exam_Type="Electrical_Question";
						%>
							<tr>
							<td><input
