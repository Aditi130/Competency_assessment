	...
	<div class="container">
				<div class="row">
					<div >
						...
						<form class="form-light mt-20" role="form" enctype="multipart/form-data" action="sub_exam" 
					method="post">
					<div class="form-group">
								<label>Select Question Set</label>
								<select name="roll" class="form-control">
								<option selected="selected">Select Role</option>
								<option value="CS_IT_Question">CS&IT_Question</option>
								<option value="Electrical_Question">Electrical_Question</option>
								<option value="Electronics">Electronics</option>
								<option value="Mechanical_Questions">Mechanical Questions</option>
							</select>
							</div>
						<div class="form-group">
