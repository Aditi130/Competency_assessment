...
<body>
	...
	<div class="container">
				<div class="row">
					<div >
						<h3 class="section-title">Search Page</h3>
						<p>
							</p>
						
						<form class="form-light mt-20" role="form" action="search_info" 
					method="post">
							...
							<button type="submit" class="btn btn-two">Search Details</button><p><br/></p>
						</form>
					</div>
						</div>
			</div>
