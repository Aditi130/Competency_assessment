	...
	<section class="container">
		<div class="row">
			<div>
				...
				<form class="form-light mt-20" role="form" action="B_E_Question"
					method="post">
					<table  style="width: 100%">
						...
						<%
							...
							ResultSet rs1 = st1
									.executeQuery("select * from co_question_and_answer where Exam_Type='B_E_Question'");
							while(rs1.next())
							{
							...
							for(int j1=0;j1<id.size();j1++)
							{
								...
								String str="select * from co_question_and_answer where Exam_Type='B_E_Question'and id='"+sid+"'";
