	...
	<section class="container">
		<div class="row">
			<div>
				...
				<form class="form-light mt-20" role="form" action="Other"
					method="post">
					<table  style="width: 100%">
						...
						<%
							...
							ResultSet rs1 = st1
									.executeQuery("select * from co_question_and_answer where Exam_Type='Other'");
							while(rs1.next())
							{
							...
							int amountcount = 0;
							int j=0;
							for(int j1=0;j1<Oid.size();j1++)
							{
								j++;
								String sid=Oid.get(j1);
							ResultSet rs = st
									.executeQuery("select * from co_question_and_answer where Exam_Type='Other' and id='"+sid+"'");
							if(rs.next()) {
								if (j == 1) {
