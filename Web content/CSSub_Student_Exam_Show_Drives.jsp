	...
	<section class="container">
		<div class="row">
			<div>
				...
				<form class="form-light mt-20" role="form" action="cs"
					method="post">
					<table  style="width: 100%">
						...
						<%
							...
							{
							ResultSet rs = st
									.executeQuery("select * from sub_co_question_and_answer where Exam_Type='CS_IT_Question' and id='"+i+"'");
							if(rs.next()) {
								if (i == 1) {
							...
							String Exam_Type="CS_IT_Question";
						%>
							<tr>
							<td><input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id1" required
								readonly="readonly" id="id" value="<%=id1%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id2" required
								readonly="readonly" id="id" value="<%=id2%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id3" required
								readonly="readonly" id="id" value="<%=id3%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id4" required
								readonly="readonly" id="id" value="<%=id4%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id5" required
								readonly="readonly" id="id" value="<%=id5%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id6" required
								readonly="readonly" id="id" value="<%=id6%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id7" required
								readonly="readonly" id="id" value="<%=id7%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id8" required
								readonly="readonly" id="id" value="<%=id8%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id9" required
								readonly="readonly" id="id" value="<%=id9%>"> <input
						...
						<tr>
							<td><input type="text" style="width: 2%" name="id10" required
								readonly="readonly" id="id" value="<%=id10%>"> <input
