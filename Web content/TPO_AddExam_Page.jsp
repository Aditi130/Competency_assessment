...
<body>
	...
	<div class="container">
				<div class="row">
					<div >
						<h3 class="section-title">Add Exam Page</h3>
						<p>
							</p>
						
						<form class="form-light mt-20" role="form" enctype="multipart/form-data" action="add_exam" 
					method="post">
					<div class="form-group">
								<label>Select Question Set</label>
								<select name="roll" class="form-control">
								<option selected="selected">Select Role</option>
								<option value="General">Plain_Degree</option>
								<option value="B_E_Question">B_E_Question</option>
								<option value="medical_field">Medical_Field</option>
								<option value="Other">Other_Field_Questions(Hotel Management, Fashion Design, Aerospace)</option>
							</select>
							</div>
						<div class="form-group">
