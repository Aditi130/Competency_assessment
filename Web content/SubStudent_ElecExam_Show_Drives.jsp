	...
	<section class="container">
		<div class="row">
			<div>
				...
				<form class="form-light mt-20" role="form" action="Electronics"
					method="post">
					<table  style="width: 100%">
						...
						<%
							...
							ResultSet rs1 = st1
									.executeQuery("select * from sub_co_question_and_answer where Exam_Type='Electronics'");
							while(rs1.next())
							{
							...
							{
								j++;
								String sid=id.get(j1);
								String str="select * from sub_co_question_and_answer where Exam_Type='Electronics'and id='"+sid+"'";
